--Begin Tools.lua :)
local SUDO = 158955285 -- put Your ID here! <===
...
1, nil, send_file, '@tgMember', dl_cb, nil)
	end
	if matches[1]:lower() == "sendplug" and matches[2] then
	    local plug = "./plugins/"..matches[2]..".lua"
		tdcli.sendDocument(msg.chat_id_, msg.id_,0, 
1, nil, plug, '@tgMember', dl_cb, nil)
    end
  end
...
_Sudoer And Admins tgGuard Bot Help :_
...
text = [[
_راهنمای ادمین و سودو های ربات تلگرام گارد:_
